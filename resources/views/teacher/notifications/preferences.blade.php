...
{{--
    The teacher panel's preference screen — teacher.notifications.preferences.
...
@section('header')
    <x-ui.page-header title="Notification preferences"
        ...
        <x-slot:actions>
            <x-ui.button variant="ghost" :href="route('teacher.notifications.index')">Back to notifications</x-ui.button>
        </x-slot:actions>
    </x-ui.page-header>
@endsection
