...
{{--
    ...
    **The solid variant is -700 in light and -400 in dark, and the shades are measured, not
    chosen** (phase-24-25 section 6.5). `bg-{token}-600 text-white` reads at 3.19:1 on amber and
    2.94:1 on yellow - a badge is body-sized text, so 4.5:1 is the bar and those are well under it.
    Dark mode was worse: white on `{token}-500` is 1.92:1 on yellow. White on `-700` is at worst
    4.92:1 and `slate-950` on `-400` is at worst 6.76:1, so both themes now pass on every token.
    `tests/Support/contrast-pairs.php` holds the numbers and A11Y-CONTRAST asserts them - lighten
    one of these and the suite says so.
--}}
...
@php
    ...
    $palette = [
        ...
        'brand' => [
            ...
            'bg-brand-700 text-white ring-brand-700 dark:bg-brand-400 dark:text-slate-950 dark:ring-brand-400',
        ...
        'indigo' => [
            ...
            'bg-indigo-700 text-white ring-indigo-700 dark:bg-indigo-400 dark:text-slate-950 dark:ring-indigo-400',
        ...
        'violet' => [
            ...
            'bg-violet-700 text-white ring-violet-700 dark:bg-violet-400 dark:text-slate-950 dark:ring-violet-400',
        ...
        'purple' => [
            ...
            'bg-purple-700 text-white ring-purple-700 dark:bg-purple-400 dark:text-slate-950 dark:ring-purple-400',
        ...
        'fuchsia' => [
            ...
            'bg-fuchsia-700 text-white ring-fuchsia-700 dark:bg-fuchsia-400 dark:text-slate-950 dark:ring-fuchsia-400',
        ...
        'pink' => [
            ...
            'bg-pink-700 text-white ring-pink-700 dark:bg-pink-400 dark:text-slate-950 dark:ring-pink-400',
        ...
        'rose' => [
            ...
            'bg-rose-700 text-white ring-rose-700 dark:bg-rose-400 dark:text-slate-950 dark:ring-rose-400',
        ...
        'red' => [
            ...
            'bg-red-700 text-white ring-red-700 dark:bg-red-400 dark:text-slate-950 dark:ring-red-400',
        ...
        'orange' => [
            ...
            'bg-orange-700 text-white ring-orange-700 dark:bg-orange-400 dark:text-slate-950 dark:ring-orange-400',
        ...
        'amber' => [
            ...
            'bg-amber-700 text-white ring-amber-700 dark:bg-amber-400 dark:text-slate-950 dark:ring-amber-400',
        ...
        'yellow' => [
            ...
            'bg-yellow-700 text-white ring-yellow-700 dark:bg-yellow-400 dark:text-slate-950 dark:ring-yellow-400',
        ...
        'lime' => [
            ...
            'bg-lime-700 text-white ring-lime-700 dark:bg-lime-400 dark:text-slate-950 dark:ring-lime-400',
        ...
        'green' => [
            ...
            'bg-green-700 text-white ring-green-700 dark:bg-green-400 dark:text-slate-950 dark:ring-green-400',
        ...
        'emerald' => [
            ...
            'bg-emerald-700 text-white ring-emerald-700 dark:bg-emerald-400 dark:text-slate-950 dark:ring-emerald-400',
        ...
        'teal' => [
            ...
            'bg-teal-700 text-white ring-teal-700 dark:bg-teal-400 dark:text-slate-950 dark:ring-teal-400',
        ...
        'cyan' => [
            ...
            'bg-cyan-700 text-white ring-cyan-700 dark:bg-cyan-400 dark:text-slate-950 dark:ring-cyan-400',
        ...
        'sky' => [
            ...
            'bg-sky-700 text-white ring-sky-700 dark:bg-sky-400 dark:text-slate-950 dark:ring-sky-400',
        ...
        'blue' => [
            ...
            'bg-blue-700 text-white ring-blue-700 dark:bg-blue-400 dark:text-slate-950 dark:ring-blue-400',
