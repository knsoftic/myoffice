...
{{--
    The admin panel's preference screen — admin.notifications.preferences.
...
@section('header')
    <x-ui.page-header title="Notification preferences"
        ...
        <x-slot:actions>
            <x-ui.button variant="ghost" :href="route('admin.notifications.index')">Back to notifications</x-ui.button>
        </x-slot:actions>
    </x-ui.page-header>
@endsection
