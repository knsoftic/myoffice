{{--
    Collaborator panel landing page — Collaborator\DashboardController, route collaborator.dashboard.

    Phase 1 has no collaborator domain data yet, so this page shows only what it can prove: the
    signed-in user's own identity, account state and login bookkeeping. Everything else is an
...
@section('header')
    <x-ui.page-header
        ...
        subtitle="Your referrals, commissions, wallet and payouts will live here."
        icon="user-group"
    ...
    @php
        ...
        $roadmap = [
            [
                'icon' => 'share',
                'title' => 'Referrals',
                'message' => 'Your referral code and tracked links, plus every student and project they bring in.',
                'phase' => 'Phase 9',
            ],
            [
                'icon' => 'calculator',
                'title' => 'Commissions',
                'message' => 'One line per payment actually received — student fees and project payments, never on sign-up alone.',
                'phase' => 'Phases 10–11',
            ],
            [
                'icon' => 'wallet',
                'title' => 'Wallet',
                'message' => 'Available, pending and paid balances, always re-derivable from the commission ledger.',
                'phase' => 'Phase 12',
            ],
            [
                'icon' => 'banknotes',
                'title' => 'Payouts',
                'message' => 'Request a payout, follow its approval and download your statements.',
                'phase' => 'Phase 12',
            ],
        ];
    @endphp
    ...
    <div class="space-y-6">
        ...
        <div>
            <x-ui.section-heading
                ...
                subtitle="The collaborator panel shell and your commission settings are set up in phase 8; each card below arrives with the phase that builds it."
                icon="sparkles"
                :divider="true"
                class="mb-4"
            />
