{{--
    Client panel landing page — Client\DashboardController, route client.dashboard.

    Phase 1 has no project or finance data yet, so this page shows only what it can prove: the
    signed-in client's own identity, account state and login bookkeeping. Everything else is an
    empty state badged with the phase that builds it — no invented totals or balances.
--}}
...
@section('header')
    <x-ui.page-header
        ...
        subtitle="Your projects, invoices, payments and support tickets will live here."
        icon="briefcase"
    ...
    @php
        ...
        $roadmap = [
            [
                'icon' => 'briefcase',
                'title' => 'My projects',
                'message' => 'Your projects with their milestones, tasks and live progress.',
                'phase' => 'Phase 6',
            ],
            [
                'icon' => 'invoice',
                'title' => 'Invoices',
                'message' => 'Every invoice raised against your projects, with its status and due date.',
                'phase' => 'Phase 13',
            ],
            [
                'icon' => 'credit-card',
                'title' => 'Payments',
                'message' => 'Payments received against your invoices and the balance still outstanding.',
                'phase' => 'Phase 13',
            ],
            [
                'icon' => 'lifebuoy',
                'title' => 'Support tickets',
                'message' => 'Raise a ticket, follow the replies, and book meetings with the team.',
                'phase' => 'Phase 22',
            ],
        ];
    @endphp
    ...
    <div class="space-y-6">
        ...
        <div>
            <x-ui.section-heading
                ...
                subtitle="Your client record and this portal are set up in phase 5; each card below arrives with the phase that builds it."
                icon="sparkles"
                :divider="true"
                class="mb-4"
            />
