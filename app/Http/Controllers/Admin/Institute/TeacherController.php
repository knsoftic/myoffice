...
final class TeacherController extends Controller
{
    ...
    */
    ...
    private function counts(Request $request): array
    {
        ...
        // `count(*)` once per `TeacherStatus` case — five identical statements, where phase-24-25
        // section 11.7 (PRF-02) allows a statement to repeat three times before it is a loop. `all`
        // is the sum of the groups, which is what the separate sixth query was measuring.
