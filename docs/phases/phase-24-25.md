...
| F-4.11 | §13.1's `Money` ask is marked **SATISFIED by phase-01 §3** and carries the canonical surface verbatim (19 methods + `App\Enums\RemainderPlacement`), with "bcmath only, intermediate scale 6, final half-up at 2, strings in and out, never a float". FIN-12's assertions are unchanged - they now pin a published list. |
