...
| [x] | §11.1 FT-06 … FT-08, §120.6 / §120.7 and the screen suite: **17 tests**. 15% of 100,000 = 15,000.00; a `total_value` base on a 200,000 project promises 30,000.00 and releases 15,000.00 twice and **no more**; a refund preserves the original; a project override beats the partner's rate; a disabled partner rule beats the override |
...
| [ ] | The project payment-trail tab on the project detail screen |
